...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="col-lg-12">
    ...
    <form method="post" id="edit" action="/dashboard/posts/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="mb-3">
          <label for="title" class="form-label">Title</label>
          <input type="text" value="{{ old('title' ,$post->title) }}"  autofocus class="form-control @error('title') is-invalid @enderror" id="title" name="title">
        ...
        <div class="mb-3">
          ...
          <input type="text" value="{{ old('slug', $post->slug) }}"  class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug">
          @error('slug')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
      @enderror
        ...
        <div class="form-group @error('category_id') has-danger @enderror">
          ...
          <br>
          <small class="text-danger">*saat mengedit postingan harap isi kembali KATEGORI</small>
        ...
        <div class="form-group @error('tag_id') has-danger @enderror">
          ...
          <br>
          <small class="text-danger">*saat mengedit postingan harap isi kembali TAG</small>
      ...
      @enderror
        ...
        {{-- <div class="form-group">
          ...
          <input type="date" value="{{old('published_at', $post->published_at)}} }}"  class="form-control @error('published_at') is-invalid @enderror" id="published_at" name="published_at">
          @error('published_at')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
        ...
        <div class="mb-3">
          ...
          <input type="checkbox" value="1" @if (isset($post->is_published)) checked @endif   id="is_published" name="is_published">
         {{-- draft --}}
        </div>
       ...
       <div class="text-center">
        ...
        <div id="PleaseWait" style="display: none;"><div class="preloader"><div class="loading"><div class="spinner-border text-primary" role="status"></div><span class="visually-hidden text-dark">Update..</span> </div></div></div>
      </form>
  </div>
