...
<div class="col-lg-12">
    <form method="post" id="post" action="/dashboard/posts" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="form-group @error('category_id') has-danger @enderror">
            <label for="category" class="text-dark">Kategori</label>
        ...
        <div class="mb-3">
            <label for="image" class="form-label text-dark">Post Image</label>
      ...
      <div class="text-center">
        <button type="submit" class="btn btn" style="background-color: rgb(143, 97, 218); color:white;"><i class="fa fa-paper-plane" aria-hidden="true"></i> Upload </button>
      </div>
        
        <div id="PleaseWait" style="display: none;"><div class="preloader"><div class="loading"><div class="spinner-border text-primary" role="status"></div><span class="visually-hidden text-dark">Uploading post</span> </div></div></div>
    </form>
</div>
