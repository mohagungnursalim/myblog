...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">List Subscriber</h1>
</div>

  <a href="{{ route('export.subscriber') }}" class="btn " style="background-color: rgb(143, 97, 218); color:white;">Export to <img src="https://img.icons8.com/color/27/000000/export-excel.png"/></a>
