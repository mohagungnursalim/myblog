...
{{--         
    ...
    @endif --}}
      ...
      <form action="/dashboard/posts"
          ...
          <div class="input-group">
              <input type="text" value="{{ request('search') }}" name="search"
                  class="form-control bg-light border-0 small" placeholder="Search posts.." aria-label="Search"
      ...
      <form action="/dashboard/tags"
          ...
          <div class="input-group">
              <input type="text" value="{{ request('search') }}" name="search"
                  class="form-control bg-light border-0 small" placeholder="Search tags.." aria-label="Search"
                  aria-describedby="basic-addon2">
              <div class="input-group-append">
                  <button class="btn btn" style="background-color: rgb(143, 97, 218); color:white;" type="submit">
                      <i class="fas fa-search fa-sm"></i>
      ...
      <form action="/dashboard/categories"
          ...
          <div class="input-group">
              <input type="text" value="{{ request('search') }}" name="search"
                  class="form-control bg-light border-0 small" placeholder="Search categories.." aria-label="Search"
                  aria-describedby="basic-addon2">
              <div class="input-group-append">
                  <button class="btn btn" style="background-color: rgb(143, 97, 218); color:white;" type="submit">
                      <i class="fas fa-search fa-sm"></i>
      ...
      <ul class="navbar-nav ml-auto">
          ...
          <p class="small text-muted">Version 2.0(23.05)</p>
        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <a class="dropdown-item d-flex align-items-center" href="/dashboard/pesanmasuk">
                <div class="dropdown-list-image mr-3">
                    ...
                    @else
                    <i class="fas fa-envelope"><span class="badge badge-danger badge-counter">New</span></i>
