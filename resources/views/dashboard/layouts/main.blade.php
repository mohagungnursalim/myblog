        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer bg-light">
                <div class="col-md-7 col-lg-8 text-center ">
                    <!-- Copyright -->
                    <div class="p-3">
                         <a class="text-dark text-decoration-none">Dibuat dengan ☕ & ❤️   di Kota Palu,Indonesia.</a>
                            <br> <br>
                            
                      <a class="text-dark text-decoration-none">© <?php echo date("Y");?> </a>
                      <a class="text-dark " href="https://the-devcode.com/"
                         >MOH.AGUNG</a
                        >
                    </div>
                    <!-- Copyright -->
