...
<a href="/dashboard/balas-pesan/" class="btn btn-primary text-white">balas</a> <br>
Total Pesan <span class="badge badge-danger badge-counter" style="background-color: rgb(80, 72, 190)">{{ $count }}</span>
