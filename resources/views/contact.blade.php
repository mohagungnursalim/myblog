...
<section class="mb-4">
    ...
    <!--Section description-->
    <p class="text-center w-responsive mx-auto mb-3" style="color: rgb(80, 79, 79)">Apakah Anda memiliki pertanyaan? Jangan ragu untuk menghubungi saya secara langsung.
</p>
    ...
    <div class="row">
        ...
        <div class="col-md-9 mb-md-0 mb-5">
            ...
            <form action="/contact" method="post" id="kontak" >
                @csrf
                <!--Grid row-->
                <div class="row">
                    ...
                    <center>
                        <div class="col">
                            <div class="md-form mb-0">
                                {{-- <label for="email" class="">Your email</label> --}}
                                <input type="text"  name="subyek" class="form-control" placeholder="Masukan subject.." >
                                @error('subyek')
                                <span class="text-danger"> {{ $message }} </span>
                                @enderror
                            </div>
        ...
        <div class="col-md-3 text-center">
            <ul class="list-unstyled mb-0">
                <li><i class="fas fa-map-marker-alt fa-2x" style="color: rgb(121, 119, 119)"></i>
                    <p style="color: rgb(80, 79, 79)">Palu, Sulawesi Tengah, Indonesia</p>
                </li>
                ...
                <li><i class="fas fa-envelope mt-4 fa-2x" style="color: rgb(121, 119, 119)"></i>
                    <p style="color: rgb(80, 79, 79)">mohagungnursalim@gmail.com</p>
                </li>
            </ul>
        </div>
        <!--Grid column-->
