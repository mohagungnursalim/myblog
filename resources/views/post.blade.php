...
<div class="container">
    ...
    <div class="row mb-5">
            ...
            <article class="my-3 fs-6">
                ...
                <center>
                    ...
                    <a class="btn btn-success" href="{{ $post->author->trakteer }}"><img alt="trakteer"
                            ...
                            width="30px" height="30px" /> Traktir Penulis </a>
                    @endisset
                ...
                @foreach ( ($post->getTags($post->tag_id)) as $tag )
                <a href="/blog?tag={{ $tag->slug }}" class="badge bg-dark"><span class="text-white"> <small><i
        ...
        <div class="col-md-4">
            <div class="" style="top: 4rem;">
                ...
                <div class="p-6 mb-2 mt-4">
                    <h5 class="fst-italic">Subscriber</h5>
                    <div class="container">
                        <div class="row">
                            ...
                            @if (Session::has('message'))
                              ...
                              <div class="input-group mb-3 mt-3">
                                <div class="input-group-prepend">
                                  ...
                                  <form action="{{ route('subscriberpost') }}" method="post" >
                                    @csrf
                                  <button class="btn btn-danger" type="submit">Subscribe</button>
                                </div>
                                <input type="text" class="form-control" name="email" required placeholder="Your email.." aria-label="" aria-describedby="basic-addon1">
                                </form>
                              </div>    
                            </div>
                ...
                <div class="p-6 mb-3">
                    <h5 class="fst-italic">Post Terbaru</h5>
                    <div class="list-group">
                        {{-- perulangan post --}}
                        @foreach ($latest as $p)
                        <a href="/blog/{{ $p->slug }}" class="list-group-item list-group-item-action" aria-current="true">
                            <div class="">
        ...
        <div class="container">
            <div class="row">
                <div class="card">
                    ...
                    <a href="/blog?author={{ $post->author->username }}" class="text-decoration-none text-danger">
    ...
    <h5 class="text-muted">Komentar</h5>
    <hr>
    </script>
